 ...
 * app/ccnl/page.tsx
 *
 * Stessa identità visiva delle altre pagine (vedi globals.css / download/page.tsx
 * / dispense/page.tsx):
 *   navy #1B2740   red #E32726   orange #F5A623
 *   yellow #FFD200   green #3AA845   blue #29A9E1   grey #B5B7BA
 *
 * I PDF stanno in public/download/ e il download è diretto, nessun login
 * richiesto. Dati spostati in lib/ccnl-data.ts.
 */
...
const Breadcrumb = () => (
  <nav aria-label="breadcrumb" className={cn(MONO, "flex items-center gap-2 text-[11px] uppercase tracking-[0.2em]")}>
    ...
    <span style={{ color: NAVY }}>C.C.N.L.</span>
  </nav>
);
    ...
    <div className="relative mx-auto max-w-7xl px-6">
      ...
      <FadeUp delay={0.16} className="mt-9 max-w-3xl space-y-5">
        <p className="text-base sm:text-lg leading-relaxed" style={{ color: INK_MUTED }}>
          ...
          <strong style={{ color: NAVY }}>n. 43 CCNL</strong> e ha lo scopo di
          sfavorire gli interessi individuali a beneficio dell&apos;interesse
          comune, creando una specie di solidarietà nell&apos;ambito della
          categoria professionale di riferimento.
        </p>
        <p className="text-base sm:text-lg leading-relaxed" style={{ color: INK_MUTED }}>
          I nostri contratti ricoprono tutti i <strong style={{ color: NAVY }}>9 macro settori economici</strong> e
          vengono rinnovati periodicamente. L&apos;importanza dei nostri
          contratti risiede in particolare nella regolamentazione dei singoli
          rapporti e nell&apos;assicurare ai lavoratori dipendenti diritti,
          salari minimi e, più in generale, condizioni lavorative dignitose.
        </p>
      </FadeUp>

      {/* Box informativo — convenzione INPS */}
      <FadeUp delay={0.22} className="mt-10 max-w-3xl">
        <div
        ...
        >
          ...
          <p className="mt-3 text-sm sm:text-base leading-relaxed text-white/85">
            La Confederazione ES.A.AR.CO., in data{" "}
            <strong className="text-white">18/02/2015</strong>, ha sottoscritto
            una convenzione con INPS Nazionale (Circolare n. 47) per la
            riscossione dei contributi di assistenza contrattuale, ai sensi
            della legge 4 giugno 1973 n. 311. All&apos;ES.A.AR.CO. è
            attribuito il codice di nuova istituzione{" "}
            <strong className="text-white">&ldquo;W310&rdquo;</strong>.
          </p>
        </div>
      </FadeUp>
    </div>
    ...
    <div className="mx-auto max-w-7xl px-6">
      <FadeUp className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className={cn(DISPLAY, "mt-2 text-2xl sm:text-3xl font-medium leading-tight")} style={{ color: NAVY }}>
            Elenco CCNL ES.A.AR.CO.
          </h2>
        </div>
        <span className="text-sm" style={{ color: INK_MUTED }}>
          {CCNL_LIST.length} contratti disponibili al download
        </span>
      </FadeUp>
      ...
      <FadeUp delay={0.1} className="mt-6">
        <p className="text-xs leading-relaxed" style={{ color: INK_MUTED }}>
          L&apos;elenco è in aggiornamento: la Confederazione è firmataria di 43
          CCNL in totale. Per un contratto non presente in questa pagina,{" "}
          <Link href="/#chi-siamo" className="font-medium underline underline-offset-4" style={{ color: BLUE }}>
            contatta la sede territoriale
          </Link>
          .
        </p>
      </FadeUp>
